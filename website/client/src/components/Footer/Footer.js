                ...
                <Row>
                    <Card body className="nav" id="footer">
                        <CardText>
                            ...
                            <a href="https://github.com/tricialeav" className="fa fa-github fa-2x icon" id="github" aria-hidden="true" target="_blank"></a>
                            <a href="https://www.linkedin.com/in/tricia-leavitt" className="fa fa-linkedin-square fa-2x icon" id="linkedin" aria-hidden="true" target="_blank"></a>
                            <a href="https://stackoverflow.com/users/8994208/tricia-leavitt" className="fa fa-stack-overflow fa-2x icon" id="stack" aria-hidden="true"
                                target="_blank"></a>
                            <a href="https://twitter.com/TriciaLeav" className="fa fa-twitter fa-2x icon" id="twitter" aria-hidden="true" target="_blank"></a>
                            </CardText>
